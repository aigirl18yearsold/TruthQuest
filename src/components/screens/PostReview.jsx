      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="mx-5 mb-4 rounded-2xl overflow-hidden bg-cream border border-paper-dim">
          <div className="flex items-center gap-2.5 px-4 pt-4">
            <div className="rounded-full flex items-center justify-center w-[38px] h-[38px] bg-teal text-ink font-display font-bold shrink-0">
          ...
          <p className="px-4 pt-3 pb-3 font-body font-semibold text-[14.5px] text-ink leading-relaxed whitespace-pre-wrap">
